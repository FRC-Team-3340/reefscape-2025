...
class Drive():
    def __init__(self):
        ...
        drive_train_motors[1].follow(drive_train_motors[0])
        drive_train_motors[3].follow(drive_train_motors[2])
        
        drive_train_motors[0].setInverted(INVERT_LEFT)
        drive_train_motors[2].setInverted(INVERT_RIGHT)
        ...
        super().__init__(leftMotor=drive_train_motors[0], rightMotor=drive_train_motors[2])
